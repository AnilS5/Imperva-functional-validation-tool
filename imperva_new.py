...
def imperva(email_id, imprv_url, dom_test):
    ...
    findElement(md.b.CSS_SELECTOR, 'div[data-testid="CurrentAccount"]').click()
    ...
    for dom in dom_test:
        ...
        md.sleep(5)
        wait.until(md.EC.presence_of_element_located((md.b.PARTIAL_LINK_TEXT, dom)))
        ...
        #wait.until(md.EC.frame_to_be_available_and_switch_to_it("embedded-content"))
        ...
        # md.sleep(5)
        #
        # wait.until(md.EC.presence_of_element_located((md.b.CSS_SELECTOR, "a[title='Details']")))
